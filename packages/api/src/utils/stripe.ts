  ...
  namespace Stripe {
    ...
    namespace DiscriminatedEvent {
      ...
      interface AccountExternalAccountEvent extends Stripe.Event {
        type: "account.external_account.created" | "account.external_account.deleted" | "account.external_account.updated";
      ...
      interface BillingPortalConfigurationEvent extends Stripe.Event {
        type: "billing_portal.configuration.created" | "billing_portal.configuration.updated";
      ...
      interface CustomerSourceEvent extends Stripe.Event {
        type: "customer.source.created" | "customer.source.deleted" | "customer.source.expiring" | "customer.source.updated";
      ...
      interface IssuingAuthorizationEvent extends Stripe.Event {
        type: "issuing_authorization.created" | "issuing_authorization.request" | "issuing_authorization.updated";
      ...
      interface PaymentMethodEvent extends Stripe.Event {
        type: "payment_method.attached" | "payment_method.automatically_updated" | "payment_method.detached" | "payment_method.updated";
        data: DiscriminatedEvent.Data<Stripe.PaymentMethod>;
      }

      interface PayoutEvent extends Stripe.Event {
        type: "payout.canceled" | "payout.created" | "payout.failed" | "payout.paid" | "payout.reconciliation_completed" | "payout.updated";
      ...
      interface QuoteEvent extends Stripe.Event {
        type: "quote.accepted" | "quote.canceled" | "quote.created" | "quote.finalized";
      ...
      interface TerminalReaderEvent extends Stripe.Event {
        type: "terminal.reader.action_failed" | "terminal.reader.action_succeeded";
      ...
      interface TopupEvent extends Stripe.Event {
        type: "topup.canceled" | "topup.created" | "topup.failed" | "topup.reversed" | "topup.succeeded";
      ...
      interface TreasuryCreditReversalEvent extends Stripe.Event {
        type: "treasury.credit_reversal.created" | "treasury.credit_reversal.posted";
        data: DiscriminatedEvent.Data<Stripe.Treasury.CreditReversal>;
      }

      interface TreasuryDebitReversalEvent extends Stripe.Event {
        type: "treasury.debit_reversal.completed" | "treasury.debit_reversal.created" | "treasury.debit_reversal.initial_credit_granted";
      ...
      interface TreasuryReceivedCreditEvent extends Stripe.Event {
        type: "treasury.received_credit.created" | "treasury.received_credit.failed" | "treasury.received_credit.succeeded";
