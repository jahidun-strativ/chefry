  ...
  return (
    <main className="min-h-screen bg-gray-100">
      <div className="mx-auto flex w-full max-w-lg flex-col p-6">
        <h1 className="text-center text-4xl font-bold">Star Tracker preview</h1>

        <a
          href="exp://u.expo.dev/0a16acb0-666e-4b5c-911f-a04ffd800ccb?channel-name=production&runtime-version=exposdk%3A49.0.0"
        ...
        <div className="rounded-lg bg-white p-0 shadow-lg">
          <img
            src="https://qr.expo.dev/eas-update?appScheme=exp&amp;projectId=0a16acb0-666e-4b5c-911f-a04ffd800ccb&amp;channel=production&amp;runtimeVersion=exposdk%3A49.0.0&amp;host=u.expo.dev"
